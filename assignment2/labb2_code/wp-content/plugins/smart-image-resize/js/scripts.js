...
(function ($) {
  ...
  $(document).on('change', '.wpSirSelectSize', function () {
    ...
    $(this).closest('tr').find('select.wp-sir-fit-mode').prop('disabled', !$(this).is(':checked'));
    if ($(this).closest('tr').find('select.wp-sir-fit-mode').val() === 'none') {
  ...
  $('.wpSirSelectSize').each(function () {
    ...
    $(this).closest('tr').find('select.wp-sir-fit-mode').prop('disabled', !$(this).is(':checked')).change();
    $(this).closest('tr').find('select.wp-sir-fit-mode').each(function () {
      if ($(this).val() === 'none') {
        $(this).closest('tr').find('input[type=number]').prop('disabled', true);
      }
    });
